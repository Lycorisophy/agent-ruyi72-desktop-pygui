...
def search_duckduckgo(query: str, num_results: int = 10, safe_search: str = "moderate") -> dict:
    ...
    try:
        ...
        headers = {
            'User-Agent': 'OpenClaw-DuckDuckGo/1.0',
...
def format_output(search_result: dict) -> str:
    """Format search results for display in OpenClaw"""
...
def main():
    parser = argparse.ArgumentParser(
        description='DuckDuckGo Search Tool for OpenClaw',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python duckduckgo.py "Python programming"
  python duckduckgo.py "OpenClaw AI" --num 10
